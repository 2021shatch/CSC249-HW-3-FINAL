...
def receiveOnePing(mySocket, ID, timeout, destAddr):
    ...
    while True:
        ...
        type, code, checksum, myID, sequence = struct.unpack("bbHHh", recPacket[20:28])
        print("The header for this ICMP reply is ", + type, code, checksum, myID, sequence)
        ...
        if type == 0 and code == 0:
          ...
          print("The RTT in ms is: ")
          timeSent = timeSent[0]
          return (timeRec - timeSent)*1000
